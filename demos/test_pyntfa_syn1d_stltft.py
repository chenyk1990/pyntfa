...
## ST
dout,w0,dw,nw=st1d(din,dt=dt,inv=0,opt=1,sym=0,ntw=31,ot=0,wind=0,verb=1)
dout=dout.reshape([n1,nw,2],order='F');
print("dout.shape is ",dout.shape)
## Inverse transform
trace=st1d(dout,dt=0.004,inv=1,opt=1,sym=0,ntw=31,ot=0,wind=0,verb=1)
...
plt.savefig('test_pyntfa_syn1d_stltft.png',format='png',dpi=300)
plt.show();
#
#fig = plt.figure(figsize=(16, 8))
#plt.subplot(3,3,1)
