...
dout2,basis,w0,dw,nw = ntfa.ntfa1d(earth,dt=1,niter=10,rect=20,ifb=1,inv=0)
...
doutn1,basisn,w02,dw2,nw2 = ntfa.ntfa1d(earth,dt=1,niter=10,rect=7,ifb=1,inv=0,ifn=1,rect1=rectn0,rect2=rectn1)
